...
# git commit -a -m "patch version bump v0.5.3"; git tag -a v0.5.3 -m "version 0.5.3"; git push origin master; git push origin v0.5.3; python setup.py sdist bdist_wheel; twine upload dist/radd-0.5.3*
