...
class Optimizer(object):
    ...
    """
    def __init__(self, simulator=None, fitparams=None, basinparams=None, kind='xdpm', pcmap=None):
        if simulator is None:
            simulator = Simulator(fitparams=fitparams, kind=kind, pcmap=pcmap)

        self.simulator = simulator
        self.fitparams = simulator.fitparams
        self.pcmap = simulator.pcmap
    ...
    def update(self, get_simulator=False, **kwargs):
        ...
        self.simulator.update(fitparams=self.fitparams, pcmap=self.pcmap)
